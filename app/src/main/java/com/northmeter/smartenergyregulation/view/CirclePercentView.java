package com.northmeter.smartenergyregulation.view;
...
/**
 * Created by dyd on 2019/6/4.
 */

public class CirclePercentView extends View{
    public static final int WIDTH_RADIUS_RATIO = 12;     // 弧线半径 : 弧线线宽 (比例)
    ...
    public CirclePercentView(Context context, @Nullable AttributeSet attrs) {
        ...
        bgColor = typedArray.getColor(R.styleable.CirclePercentView_circleBgColor, getResources().getColor(R.color.color_progress_back));
        progressColor = typedArray.getColor(R.styleable.CirclePercentView_circleProgressColor, getResources().getColor(R.color.white));
        ...
        startColor = typedArray.getColor(R.styleable.CirclePercentView_circleStartColor, getResources().getColor(R.color.white));
        endColor = typedArray.getColor(R.styleable.CirclePercentView_circleEndColor, getResources().getColor(R.color.white));
        typedArray.recycle();
        init();
    }
